  ...
  return (
    <Container.Sub loose>
      <TextContainer align="left">
        <h2>
          <Danger>Fake </Danger>
          Book Traders Terms of Service
        </h2>
        <h3 className="margin-top">1. Terms</h3>
        <p>
          By accessing the website at{' '}
          <Link href="/" type="normal">
            http://book-traders.glitch.me
          </Link>, you are agreeing to be bound by these
          terms of service, all applicable laws and
          regulations, and agree that you are responsible
        ...
        <List variation="lower-alpha">
          <li>
            ...
            <List variation="upper-roman">
              ...
              <li>
                ...
                software contained on Book Traders' website;
              </li>
              <li>
          ...
          <li>
            ...
            terminated by Book Traders at any time. Upon
        ...
        <List variation="lower-alpha">
          <li>
            The materials on Book Traders' website are
            provided on an 'as is' basis. Book Traders makes
          ...
          <li>
            Further, Book Traders does not warrant or make
        ...
        <h3>4. Limitations</h3>
        <p>
          In no event shall Book Traders or its suppliers be
          ...
          use or inability to use the materials on Book
          Traders' website, even if Book Traders or a Book
          Traders authorized representative has been
        ...
        <p>
          The materials appearing on Book Traders website
          could include technical, typographical, or
          photographic errors. Book Traders does not warrant
          that any of the materials on its website are
          accurate, complete or current. Book Traders may
          make changes to the materials contained on its
          website at any time without notice. However Book
          Traders does not make any commitment to update the
          materials.
        </p>
        <h3>6. Links</h3>
        <p>
          Book Traders has not reviewed all of the sites
          ...
          by Book Traders of the site. Use of any such
          linked website is at the user's own risk.
        </p>
        <h3>7. Modifications</h3>
        <p>
          Book Traders may revise these terms of service for
        ...
        <p>
          ...
          construed in accordance with the laws of Ottawa,
          ON and you irrevocably submit to the exclusive
